...
impl PhysicalOptimizer {
    ...
    pub fn new() -> Self {
        let rules: Vec<Arc<dyn PhysicalOptimizerRule + Send + Sync>> = vec![
            ...
            // This rule prepares the physical plan for placeholder resolution by wrapping it
            // in a `TransformPlanExec` with a `ResolvePlaceholdersRule` if it contains any unresolved placeholders.
